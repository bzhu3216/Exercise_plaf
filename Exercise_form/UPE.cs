...
namespace Exercise_form
{
    public partial class UPE : Form
    {
        ...
        private void UPE_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (ctf != null)
            {
                ...
                ctf.answ =textBox2.Text ;
                ctf.emnum = comboBox5.SelectedIndex + 1;
        ...
        {
            if (comboBox4.SelectedIndex == 0) textBox2.Text = "I:       ";
            if (comboBox4.SelectedIndex == 1) textBox2.Text = "I:       II:";
            if (comboBox4.SelectedIndex == 2) textBox2.Text = "I:        II:        III:         ";
        }

        private void shu(object sender, EventArgs e)
        {
